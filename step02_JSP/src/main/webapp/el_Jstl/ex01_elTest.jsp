...
<jsp:useBean id="p" class="ex0416.el.Product"></jsp:useBean>
<%=p %> <br>
상품코드 :  ${p.code} <br> <!-- p.getCode() 호출 -->
상품이름 :  ${p.name } <br> <!-- p.getName() 호출 -->
상품수량 :  ${p.qty }<br> <!-- p.getQty() 호출 -->
상품가격 :  ${p.price }<br> <!-- p.getPrice() 호출 -->
총 금액 :  ${p.qty * p.price }원<br> 
</body>
</html>